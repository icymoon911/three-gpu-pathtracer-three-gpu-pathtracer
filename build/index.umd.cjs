...
`;
	...
	class WebGLPathTracer {
		...
		async exportAsync( options = {} ) {
			...
			if ( denoise ) {
				...
				denoiseCopyQuad = new Pass_js.FullScreenQuad( denoiseMat );

				denoiseTarget = new three.WebGLRenderTarget( w, h, {
					format: three.RGBAFormat,
					type: three.FloatType,
					magFilter: three.NearestFilter,
					minFilter: three.NearestFilter,
	...
	class VolumetricCloudMaterial extends three.MeshStandardMaterial {
	...
	exports.EXRExporter = EXRExporter;
	...
	exports.VolumetricCloudMaterial = VolumetricCloudMaterial;
